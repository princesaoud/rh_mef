...
class DrawerUserControllerPublic extends StatefulWidget {
  const DrawerUserControllerPublic({
    Key key,
  ...
  @override
  _DrawerUserControllerPublicState createState() =>
      _DrawerUserControllerPublicState();
}

class _DrawerUserControllerPublicState extends State<DrawerUserControllerPublic>
          ...
          child: Row(
            children: <Widget>[
              SizedBox(
                ...
                //we divided first drawer Width with HomeDrawerPublic and second full-screen Width with all home screen, we called screen View
                height: MediaQuery.of(context).size.height,
