...
class _RetraiteProccedureState extends State<RetraiteProccedure> {
  ...
  @override
  void initState() {
    drawerIndex = DrawerIndex.Retraite;
...
class RetraiteProccedureContent extends StatefulWidget {
  @override
  _RetraiteProccedureContentState createState() =>
      _RetraiteProccedureContentState();
}

class _RetraiteProccedureContentState extends State<RetraiteProccedureContent> {
// static var view = '${viewValue.home}';
  var view = viewValue.home;
                    ...
                    if (snapshot.data == null ||
                      ...
                      listStepsSR.forEach((element) {
                        ...
                        listStepRetreat[1].updated =
                            new DateFormat('EEE, MMM d, ' 'yy').format(
                                snapshot.data.data()['updated'].toDate());
                        // listColors.add(colorForRetreateList(element));
                      });
